...
_AGENT_TRACE_SAFE_SUMMARIES: dict[AgentTraceReasonCode, str] = {
    ...
    AgentTraceReasonCode.MAX_ROUNDS_REACHED: "已达到证据复核轮次上限，正在整理已有结果。",
    AgentTraceReasonCode.DUPLICATE_AGENT_QUERY: "已阻止重复检索，正在整理已有结果。",
    AgentTraceReasonCode.UNSUPPORTED_AGENT_REQUEST: "已阻止不受支持的证据复核请求，正在整理已有结果。",
    AgentTraceReasonCode.INVALID_AGENT_REQUEST: "未找到可用的证据复核步骤，正在整理已有结果。",
    AgentTraceReasonCode.ORCHESTRATOR_MODEL_UNAVAILABLE: "查询规划暂不可用，正在基于本地证据完成回复。",
    AgentTraceReasonCode.ORCHESTRATOR_TIMEOUT: "查询规划步骤超时，正在基于已有本地证据完成回复。",
    AgentTraceReasonCode.ORCHESTRATOR_INVALID_RESPONSE: "查询规划结果无效，正在基于已有本地证据完成回复。",
    ...
    AgentTraceReasonCode.NEGOTIATION_FALLBACK: "证据复核已安全停止，正在整理已有结果。",
    AgentTraceReasonCode.NEGOTIATION_COMPLETED: "证据复核已完成。",
    AgentTraceReasonCode.NEGOTIATION_COMPLETED_WITH_FALLBACK: "证据复核已通过安全兜底完成。",
}
