...
contextBridge.exposeInMainWorld("agentDesktop", {
  ...
  getLoginItemStatus: () => ipcRenderer.invoke("agent-pet:get-login-item-status"),
  setLoginItemEnabled: (enabled) => ipcRenderer.invoke("agent-pet:set-login-item-enabled", enabled),
  retrySidecar: () => ipcRenderer.invoke("agent-pet:retry-sidecar"),
