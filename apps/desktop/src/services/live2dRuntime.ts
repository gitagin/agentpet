...
export type Live2DAssetStatus = "loading" | "recognized" | "missing" | "error";
...
export type Live2DRuntimeStatus = "not-connected" | "loading-assets" | "assets-ready" | "mount-ready" | "failed";
