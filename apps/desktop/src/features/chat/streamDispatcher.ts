...
const TRACE_SAFE_SUMMARIES: Record<ChatTraceReasonCode, string> = {
  ...
  max_rounds_reached: "已达到证据复核轮次上限，正在整理已有结果。",
  duplicate_agent_query: "已阻止重复检索，正在整理已有结果。",
  unsupported_agent_request: "已阻止不受支持的证据复核请求，正在整理已有结果。",
  invalid_agent_request: "未找到可用的证据复核步骤，正在整理已有结果。",
  orchestrator_model_unavailable: "查询规划暂不可用，正在基于本地证据完成回复。",
  orchestrator_timeout: "查询规划步骤超时，正在基于已有本地证据完成回复。",
  orchestrator_invalid_response: "查询规划结果无效，正在基于已有本地证据完成回复。",
  agent_timeout: "检索步骤超时，正在基于已有本地证据完成回复。",
  agent_invocation_failed: "检索步骤未完成，正在基于已有本地证据完成回复。",
  negotiation_fallback: "证据复核已安全停止，正在整理已有结果。",
  negotiation_completed: "证据复核已完成。",
  negotiation_completed_with_fallback: "证据复核已通过安全兜底完成。",
};
