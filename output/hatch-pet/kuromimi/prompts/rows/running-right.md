Create one horizontal animation strip for Codex pet `kuromimi`, state `running-right`.
...
Identity: same pet in every frame: Compact chibi anime cat-eared girl companion, black long hair with soft pink accents, pink-violet eyes, black oversized techwear jacket, small cyan pendant, warm quiet expression, no readable logos or text.. Preserve silhouette, face, proportions, markings, palette, material, style, and props.
Style: Pet-safe sprite: compact full-body mascot, readable in a 192x208 cell, clear silhouette, simple face, stable palette/materials, and crisp edges for chroma-key extraction. Style `sticker`: Polished sticker mascot with bold clean shapes, crisp outline, flat colors, and minimal highlight detail. User style notes: high-quality anime sticker sprite, compact upper-body chibi, expressive face, readable silhouette at 192x208, transparent-ready chroma background.
